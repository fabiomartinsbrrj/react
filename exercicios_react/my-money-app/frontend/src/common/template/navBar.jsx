                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li className="user-footer">
                                <div className="pull-right">
                                    <a href="#" onClick="btn btn-default btn-flat">Sair</a>
                                </div>
                            </li>
                        </ul>
...
const masStateToProps = state => ({ user: state.auth.user})
const mapDispacthToProps = dispatch => bindActionCreators({ logout }, dispatch)
export default connect( masStateToProps, mapDispacthToProps)(Navbar)